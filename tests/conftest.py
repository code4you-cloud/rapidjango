...
# WARNING: Ensure imports from `rapidjango` comes after this line
from rapidjango import app, settings, db  # noqa
from rapidjango.cli import create_user, cli  # noqa
